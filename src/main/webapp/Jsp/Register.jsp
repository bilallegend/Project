            ...
            <div id="signup">
              ...
              <div id="nam" style="display:flex;height:130px">  
                <%
                  ...
                  <div>
                    ...
                    <p id="errname">username should have atleast 6 should not have special characters
                    </p>
                    <label class="pad-top">Email Id
                    </label>
                    <div class="dv">
                      <div class="im"> 
                    ...
                    <p id='errmail'>Invalid mail
                    </p>
                  </div>
                  </div>
                 <div id="sec-div">
                  <label class="pad-lef">Password
                  </label>
                  <div class="dv mar-lef">
                    <div class="im"> 
                      <i class="fa fa-key i" aria-hidden="true">
                      </i>
                    </div>
                    <input type="password" name="pass" class="in" id="usrpassword_up" onkeyup="check()"/>
                  </div>
                  <p id='errpass'>Password should have atleast and lesser than 11 letters can contain . or _
                  </p>
                  <label class="pad-top pad-lef">Confirm Password
                  </label>
                  <div class="dv mar-lef">
                    <div class="im"> 
                      <i class="fa fa-key i" aria-hidden="true">
                  ...
                  <p id='errpassword'>Password didn't match
                  </p>
                  <label class="pad-top pad-lef">Mobile Number
                  </label>
                  <div class="dv mar-lef">
                    <div class="im"> 
                      <i class="fa fa-mobile" aria-hidden="true" id="ph">
                      </i>
                    </div>
                    <input type="text/number" name="num" class="in" maxlength="10" id="usrnum_up" onkeyup="check()"/>
                  </div>
                  <p id='errnum'>Invalid mobilenumber
                  </p>
              ...
              <div id="signin">
                <div id="rib" class="mar rib">LOGIN
                  ...
                  <p id="errnamin" class="ale">Invalid username
                  </p>
                  <label class="pad-lef pa">Email
                  </label>
                  <div class="dv mar-lef" style="margin-top:0px">
                    <div class="im">
                      <i class="fa fa-envelope-o" aria-hidden="true">
                  ...
                  <p id="errmailin" class="ale">Invalid mail
                  </p>
                  <label class="pad-lef pa">Password
                  </label>
                  <div class="dv mar-lef" style="margin-top:0px">
                    <div class="im"> 
                      <i class="fa fa-key i" aria-hidden="true">
                  ...
                  <p id="errpassin" class="ale">Invalid password
                  </p>
                ...
                <div id="menu">
                  ...
                  <div>
                    <p>
                      <a href="http://gamecenterdesign.zcodeusers.com/MMAB-PROJECT/Html/Instruction.html">INSTRUCTIONS
                      </a>
                    </p>
                  </div>
                  <div class="exit">
                ...
                <p class="sign" id="sgnup">SIGNUP
                </p>
                <p class="sign sgnin" id="sig">SIGNIN
                </p>
                </div>
                <div class="edit1">
                  <p class="cha-pas">PERSONAL INFORMATION
                  </p>
                  ...
                  <div id="sec-div st">
                    ...
                    <p id="na">username should have atleast 6 should not have special characters
                    </p>
                    <label class="pad-top pad-lef">Email
                    </label>
                    <div class="dv mar-lef">
                      <div class="im">
                        <i class="fa fa-envelope-o" aria-hidden="true">
                ...
                <i class="fa fa-caret-right" id="aro" aria-hidden="true">
                </i>
                <div class="feed"> 
                  <span>Tournament ID
                  </span>
                  <p class="tournament" id="currtour">AB-1
                  </p>
                  <p>Ends in
                  </p>
                  <h1>1h 29s
                  </h1>
                  <i class="fa fa-commenting-o" aria-hidden="true" id="fed">
                    <span>Feeds
                    </span>
                  </i>
                  <i class="fa fa-caret-left" id="leftaro" aria-hidden="true">
                  </i>
                </div>
                <div class="feeds">
                  <button type="submit" class="feedbtn feedfrstbtn" name='toWatch'>Replays
                  </button>
                  <button type="submit" class="feedbtn feedsndbtn hover" name='toWatch'>Live
                  </button>
                  <div class="main" id='feedsFlow'>
                  </div>
                </div>
              </div>
              <div class="profil" id="img">
              </div>
              <div class="profilediv">
                ...
                <h5 id="name">madhubalan.m
                </h5>
                <p id="mail">madhubalan.m@zohouniv.com
                </p>
              </div>
              <button type="submit" class="edit" id='Edit'>Edit profile
              </button>
              <button type="submit" id="chan-pass">Change password
              </button>
              <button type="submit" id="prof">View Profile
              </button>
              <button type="submit" id="out">signout
              </button>
            </div>
            <div class="change">
              <p class="cha-pas">Change Password
              </p>
              <div>
                <input type="password" placeholder="Current Password" id="curr"/>
                <i class="fa fa-lock" aria-hidden="true">
                </i>
                <input type="password" placeholder="New Password" id="new"/>
                <i class="fa fa-lock" aria-hidden="true">
                </i>
                <input type="password" placeholder="Confirm Your Password" id="new1"/>
                <i class="fa fa-lock" aria-hidden="true">
                </i>
              </div>
              <button class="chan" id="change">CHANGE
              </button>
            </div>
            </body>
          </html>
